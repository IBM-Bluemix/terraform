...
func updateDevelopers(api cfv2.Spaces, spaceGUID string, d *schema.ResourceData) error {
...
func updateManagers(api cfv2.Spaces, spaceGUID string, d *schema.ResourceData) error {
...
func updateAuditors(api cfv2.Spaces, spaceGUID string, d *schema.ResourceData) error {
